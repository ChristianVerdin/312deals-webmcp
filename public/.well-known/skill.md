---
name: 312Deals
description: Find Chicago food & drink deals — happy hours, daily specials, brunch, late-night, game day, chain app deals — across 149 city + suburban neighborhoods.
...
> How to look up Chicago food & drink deals via 312Deals' REST API, MCP server, or WebMCP browser tools. 80,000+ verified deals at 12,000+ venues across 149 neighborhoods, updated weekly.
...
| `GET /api/v1/neighborhoods` | none | All 149 neighborhoods |
